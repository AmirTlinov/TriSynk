...
- `reports/metrics.json` is regenerated by [scripts/measure_metrics.sh](../scripts/measure_metrics.sh); CI enforces thresholds via [scripts/check_metrics.py](../scripts/check_metrics.py).
